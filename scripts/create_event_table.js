...
async function run() {
  const schemaPath = path.join(__dirname, '../database/event_registrations_schema.sql');
  ...
  try {
    ...
    console.log('Executing event_registrations_schema.sql...');
    ...
    console.log('Event registrations table migration completed successfully!');
    await conn.end();
  } catch (error) {
